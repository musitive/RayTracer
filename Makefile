...
tracer:
	g++ -g -std=c++17 Vec.cpp Object.cpp Sphere.cpp Triangle.cpp Intersection.cpp Camera.cpp Environment.cpp FileManager.cpp RayTracer.cpp Scene.cpp main.cpp -o $@
