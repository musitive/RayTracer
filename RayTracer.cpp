...
Colord RayTracer::calculateDiffuse(const Intersection& i) {
    ...
    // return i.computeColor(env->light, blocked, env->ambient_light);
...
// bool RayTracer::isObjectBlocked(const Intersection& i, const Position& light_position) {
//     Direction direction_to_light = light_position - i.getPosition();
//     double distance = length(direction_to_light);
